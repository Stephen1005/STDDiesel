                        ...
                        <div class="col-lg-5">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button onclick="tampilProduk()" id="kode_produk" class="btn btn-info btn-flat" type="button"><i class="fa fa-arrow-right"></i></button>
                                </span>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(function () {
        ...
        // Disable form-penjualan inputs initially
        $('#kode_produk, #diterima, #tipe_nota, #diskon').prop('disabled', true);
    ...
    function pilihMember(id, kode) {
        ...
        // Enable all inputs in form-penjualan after selecting member
        $('#kode_produk, #diterima, #tipe_nota, #diskon').prop('disabled', false);
